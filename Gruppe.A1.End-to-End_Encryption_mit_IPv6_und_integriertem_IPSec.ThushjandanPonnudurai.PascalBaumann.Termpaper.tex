...
\subsection{IPSec}
\label{ssec:IPSec}
IPSec is a widely used tunneling protocol suite. As it is a suite, there are many different interlocking parts and many asterisks when deploying IPSec. But as stated in \cite{Bellovin2009}: \textquotedblleft These can be used to provide confidentiality, integrity, and replay protection;\textquotedblright.
