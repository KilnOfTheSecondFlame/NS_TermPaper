...
In short, a SA defines a relationship between two IPsec peers and specifies which options of the ISAKMP and underlying protocols will be used in traffic between these partners.
